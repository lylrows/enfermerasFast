...
export class FirebaseAuthService implements OnDestroy {
  ...
  //private sharingObservable= new BehaviorSubject<ProfileModel>({} as ProfileModel);

    //public readonly currentUserBS: Observable<FirebaseProfileModel> = this.sharingObservable.asObservable();
  ...
  private setUserModelForProfile(userResult?: (User | null)): FirebaseProfileModel {
    ...
    if (userResult) {
      ...
      userModel.uid = userResult.uid || 'es null';
    }
  ...
  public getProfileStore(dataSource: Observable<FirebaseProfileModel>): DataStore<FirebaseProfileModel> {
    ...
    //console.log('profileDataStore:',this.profileDataStore);
    return this.profileDataStore;
  }

  /////

  // set UserModelForProfileBS(userResult: (ProfileModel | null)) {
  //   this.sharingObservable.next(userResult);
  // }
